...
VALID_TICKERS = {
    ...
    # Mega caps
    "AAPL", "MSFT", "GOOGL", "GOOG", "AMZN", "META", "NVDA", "TSLA", "BRK",
    # Tech
    "AMD", "INTC", "AVGO", "ORCL", "CRM", "ADBE", "NFLX", "PYPL", "SQ", "SHOP",
    # Finance
    "JPM", "BAC", "WFC", "GS", "MS", "C", "BLK", "SCHW", "AXP", "V", "MA",
    # Healthcare
    "JNJ", "UNH", "PFE", "MRK", "ABBV", "LLY", "TMO", "ABT", "BMY", "GILD",
    # Energy
    "XOM", "CVX", "COP", "SLB", "EOG", "MPC", "VLO", "PSX", "OXY", "HAL",
    # Consumer
    "WMT", "COST", "HD", "TGT", "LOW", "SBUX", "MCD", "NKE", "DIS", "CMCSA",
    # Industrial
...
EXCLUDED_WORDS = {
    ...
    "WE", "AI", "CEO", "CFO", "CTO", "IPO", "GDP", "CPI", "PPI", "PCE",
    "FED", "SEC", "FBI", "CIA", "USA", "UK", "EU", "UN", "IMF", "WHO",
    "THE", "AND", "FOR", "NOT", "BUT", "ARE", "WAS", "HAS", "HAD", "HIS",
    "HER", "YOU", "ALL", "CAN", "HER", "WAS", "ONE", "OUR", "OUT", "DAY",
    "GET", "HAS", "HIM", "HOW", "ITS", "LET", "MAY", "NEW", "NOW", "OLD",
    "SEE", "WAY", "WHO", "BOY", "DID", "OWN", "SAY", "SHE", "TOO", "USE",
    "PM", "EST", "PST", "UTC", "YTD", "QOQ", "MOM", "YOY", "ATH", "ATL",
}
...
TOPIC_KEYWORDS = {
    "macro": [
        "inflation", "gdp", "unemployment", "employment", "jobs",
        "recession", "economy", "economic", "monetary", "fiscal",
        "deficit", "debt", "stimulus", "tightening", "easing",
    ],
    "rates": [
        "interest rate", "rate hike", "rate cut", "fed funds",
        "yield", "yields", "treasury", "bonds", "duration",
        "basis points", "bps", "fomc", "dot plot",
    ],
    "earnings": [
        "earnings", "revenue", "eps", "guidance", "outlook",
        "beat", "miss", "quarterly", "q1", "q2", "q3", "q4",
        "profit", "margin", "growth", "yoy", "qoq",
    ],
    "tech": [
        "ai", "artificial intelligence", "machine learning", "cloud",
        "software", "saas", "semiconductor", "chip", "gpu", "data center",
    ...
    "options": [
        "options", "calls", "puts", "strike", "expiry", "expiration",
        "iv", "implied volatility", "gamma", "delta", "theta", "vega",
        "spread", "straddle", "strangle", "iron condor",
    ],
    "markets": [
        "market", "stock", "equity", "index", "s&p", "nasdaq", "dow",
        "russell", "bull", "bear", "rally", "selloff", "correction",
        "volatility", "vix",
    ],
}
...
class MetadataExtractor:
    ...
    def estimate_quality(self, text: str) -> float:
        ...
        sentence_ratio = sentences / max(len(words) / 15, 1)  # Expect ~15 words/sentence
