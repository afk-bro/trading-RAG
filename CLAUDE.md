...
**Do not reference Claude or AI in any git artifacts.** This includes:
- Commit messages (no "Generated by Claude", "Co-Authored-By: Claude", etc.)
- PR titles and descriptions
- Code comments
- Branch names

Write commits and PRs as if a human developer authored them.
